...
BEGIN
  ...
  -- Skip read-tracker entries from communications to avoid noisy notifications
  IF TG_ARGV[0] = 'communication' AND TG_OP != 'DELETE' AND (_row->>'provider') = 'gmail-read-tracker' THEN
