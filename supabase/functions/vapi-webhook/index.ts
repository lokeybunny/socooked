  ...
  try {
    ...
    if (messageType === "end-of-call-report") {
      ...
      if (customerLead) {
        ...
        // ─── Dropped-call auto SMS — KILL SWITCH (2026-05-14) ───
        // The "Busy in a meeting / IG reel" auto-reply is permanently disabled
        // because it was getting Warren's number flagged as spam.
