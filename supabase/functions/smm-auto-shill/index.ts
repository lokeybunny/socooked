...
/** 200+ natural openers to prepend to shill/raid copy — avoids spam filters */
const OPENER_POOL = [
  // GM / greetings
  "GM everyone 🌅", "gm gm how we doing today", "gm fam hope y'all good",
  "good morning beautiful people", "gm to the real ones only", "rise and grind fam",
  "GM from the trenches", "gm gm another day another W", "wakey wakey let's get it",
  "morning check in real quick", "gm who's up early today", "GM legends",
  "gm to everyone holding strong", "top of the morning to y'all", "gm vibes only",
  "gm let's have a great day", "GM and good vibes", "gm gm what's popping",
  "early morning scrolling and found this", "gm hope your coffee's strong today",
  // Casual hey/yo
  "yo what's good everyone", "hey everyone what's up", "what's good y'all",
  "yo yo yo", "aye what's happening", "hey fam quick one", "sup everyone",
  "what's the move today", "hey y'all check this", "yooo had to share this",
  "hey what's everyone up to", "waddup fam", "what's poppin today",
  "hey real quick", "yo someone put me on to this", "hey hey hey",
  "what's brackin", "yoo this is wild", "heyy just dropping in",
  "yo check this out real quick",
  // Casual sharing
  "just scrolling and had to share", "can't keep this to myself",
  "had to put y'all on", "dropping this here", "thought y'all should see this",
  "passing this along", "sharing some alpha", "let me put y'all on to something",
  "just came across this", "stumbled on something interesting",
  "ok I had to share this one", "found this while scrolling",
  "this popped up on my feed", "putting y'all on game",
  "y'all need to see this", "couldn't scroll past without sharing",
  "this one caught my eye", "had to stop and share this",
  "ok but look at this", "saw this and immediately thought of y'all",
  "someone showed me this today", "this just landed on my timeline",
  "sharing because I think y'all should know", "peep this real quick",
  "need everyone to see this", "look what just dropped",
  // Opinion / reaction
  "ok hear me out", "not gonna lie this is it", "alright let's talk about it",
  "can we talk about this for a sec", "been thinking about this all day",
  "ngl this hits different", "ok but fr tho", "honestly tho",
  "real talk for a second", "no cap this is interesting",
  "lowkey been watching this", "I'm not even gonna front",
  "gonna be honest with y'all", "my honest reaction",
  "this might be controversial but", "idk about y'all but I'm feeling this",
  "hear me out on this one", "unpopular opinion maybe but",
  "not gonna sugarcoat it", "straight up this is fire",
  "I said what I said", "yeah I'm putting this out there",
  "don't sleep on this fr", "calling it right now",
  "mark my words on this", "I rarely share stuff but this one's different",
  // Vibes / mood
  "happy vibes only today", "hope everyone's having a great day",
  "vibes are immaculate today", "today feels like a good day",
  "woke up feeling bullish", "energy is right today",
  "good energy only", "positive vibes rolling in",
  "the vibes are off the charts rn", "feeling good about today",
  "this day just keeps getting better", "already a great day",
  "the energy today is different", "today's gonna be a good one",
  "living my best life rn", "mood is unmatched today",
  "can't complain about today", "this the type of day I live for",
  "everything's clicking today", "today hits different ngl",
  // Time-based
  "late night thoughts", "afternoon check in", "checking in real quick",
  "just woke up to this", "evening scroll and I found gold",
  "midnight musings", "3am and I can't stop thinking about this",
  "lunch break discovery", "mid-day drop", "nighttime vibes",
  "post-coffee thoughts", "weekend energy right here",
  "Sunday scroll brought me this", "Friday feeling this",
  "hump day motivation", "Monday fuel right here",
  "end of day thought", "before I sleep gotta share this",
  "early bird catches the W", "night owls wya",
  // Hype / excitement
  "this one's for the culture", "real ones know", "who's up rn",
  "quick share before I forget", "LFG no cap", "we're so early",
  "this is the one", "trust the process", "buckle up",
  "it's happening", "this is just the beginning", "the future is now",
  "about to change the game", "history in the making",
  "y'all aren't ready for this", "this is what we've been waiting for",
  "the wait is over", "something big is brewing",
  "I can feel it in the air", "things are about to get interesting",
  "pay attention to this", "don't miss this wave",
  "the train is leaving the station", "last call before takeoff",
  "boarding now 🚀", "strap in", "this is your sign",
  // Questions / engagement
  "anyone else seeing this", "am I the only one excited",
  "y'all peeped this yet", "thoughts on this",
  "what do y'all think about this", "who else is paying attention",
  "curious what everyone thinks", "tell me I'm not crazy",
  "is it just me or is this huge", "who's been following this",
  "anyone else bullish rn", "raise your hand if you see it too",
  "what's everyone's take", "am I tripping or is this fire",
  "y'all seeing what I'm seeing", "who else caught this",
  "can someone explain why more people aren't talking about this",
  "why is nobody talking about this", "how is this flying under the radar",
  "am I late or am I early",
  // Wisdom / cool takes
  "fortune favors the bold", "patience pays off", "slow and steady wins",
  "the best time was yesterday the next best time is now",
  "winners move in silence", "stay hungry stay humble",
  "scared money don't make money", "bet on yourself",
  "trust your gut on this one", "do your own research but wow",
  "not financial advice but", "just saying", "take this however you want",
  "read that again", "let that sink in", "iykyk",
  "the smart money is watching", "follow the smart money",
  "this is what separates the winners", "legends recognize legends",
  // Short punchy
  "aight check it", "boom", "hold up", "wait for it",
  "ok ok ok", "say less", "period", "that's it that's the tweet",
  "no further questions", "mic drop", "facts only",
  "big if true", "this right here", "read this",
  "save this tweet", "bookmark this", "pin this",
  "screenshot worthy", "this aged well already", "called it",
  // Conversational / natural
  "so I was scrolling today and", "random thought but",
  "ok so picture this", "storytime real quick",
  "little thread for y'all", "mini update for the fam",
  "just a quick one", "short and sweet",
  "keeping it brief but", "one sec gotta share this",
  "before I go offline", "last post for today but",
  "almost forgot to share this", "oh btw",
  "in case y'all missed it", "icymi", "psa real quick",
  "reminder for everyone", "daily dose of alpha",
  "your daily reminder", "pro tip", "hot take incoming",
  // Chill / humble
  "no pressure just vibes", "take it or leave it",
  "do with this what you will", "just putting it out there",
  "food for thought", "chew on this for a bit",
  "marinate on this", "sleep on it if you want",
  "or don't listen to me what do I know", "just my two cents",
  "grain of salt and all that", "humble opinion",
  "not trying to tell anyone what to do but", "respectfully",
  "with all due respect this is huge", "casually dropping this",
  "no big deal just", "nothing major just",
  "oh nothing just", "totally normal stuff",
];
