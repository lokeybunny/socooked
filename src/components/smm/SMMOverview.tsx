    ...
    <div className="space-y-6">
      ...
      {viewMode === 'byPlatform' ? (
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="glass-card p-5 space-y-3">
            <h3 className="text-sm font-semibold text-foreground flex items-center gap-2"><RefreshCw className="h-4 w-4 animate-spin" /> Processing Posts ({processingPosts.length}) <span className="ml-auto"><CronCountdown onCronFire={onRefresh} /></span></h3>
