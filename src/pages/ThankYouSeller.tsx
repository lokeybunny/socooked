    ...
    <div className="relative min-h-screen bg-background text-foreground">
      ...
      <main className="relative z-10 flex flex-col items-center px-4 sm:px-6 pt-8 sm:pt-16 pb-20">
        <motion.div className="max-w-lg w-full text-center" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          <p className="text-[9px] sm:text-[10px] md:text-xs tracking-[0.3em] sm:tracking-[0.4em] uppercase text-muted-foreground/60 mb-3">Land Sales</p>
          <h1 className="text-xl sm:text-2xl md:text-3xl font-bold tracking-tight mb-2">Thank You for Your Submission!</h1>
          <p className="text-xs sm:text-sm text-muted-foreground/60 font-light mb-10 sm:mb-14">We've received your property details. Here's what happens next.</p>
        </motion.div>

        <div className="max-w-md w-full flex flex-col gap-4 sm:gap-5">
          {[
            { icon: Mail, n: 1, title: 'Confirmation Sent', desc: "Check your email for a confirmation of your property submission." },
            { icon: Phone, n: 2, title: 'Offer Coming Soon', desc: 'Our team will review your property and send you a cash offer within 24–48 hours.' },
            { icon: CheckCircle, n: 3, title: "You're All Set", desc: 'No obligation — review the offer at your own pace.' },
