...
function HeroShowcaseVideo() {
  ...
  return (
    <motion.div
      ...
      className="relative group mx-auto w-full flex flex-col items-center"
      onMouseEnter={handleMouseEnter}
      onMouseLeave={handleMouseLeave}
    >
      <div
        className="relative aspect-[9/16] rounded-2xl overflow-hidden bg-black border border-white/10 shadow-2xl mx-auto w-full max-h-[80vh] sm:max-h-[85vh]"
        style={{ maxWidth: 'calc(85vh * 9 / 16)', boxShadow: '0 30px 60px -15px rgba(0,0,0,0.85), 0 15px 35px -10px rgba(34,211,238,0.25)' }}
      >
        <video
          ref={videoRef}
    ...
    <div className="min-h-screen bg-background text-foreground antialiased">
      ...
      <footer className="py-10 px-5 sm:px-8 border-t border-border/40">
        <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-4 text-center text-[10px] tracking-[0.25em] uppercase text-muted-foreground">
          ...
          <div className="text-[9px] tracking-[0.3em] text-muted-foreground/50">Formally Known As STU25.com</div>
