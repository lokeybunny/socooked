...
const AGENTS = [
  ...
  { id: 'research-finder', label: 'Research Finder', role: 'Finder Agent — Google / B2B / X', icon: Search, color: 'from-teal-500 to-emerald-600', ring: 'ring-teal-500/30', bg: 'bg-teal-500/10', text: 'text-teal-400', pulse: 'bg-teal-500', connected: true, group: 'standalone' },
] as const;
