...
const AGENTS = [
  ...
  { id: 'content-manager', label: 'Higgsfield AI', role: 'Content Agent — Video/Audio', icon: Bot, color: 'from-amber-500 to-orange-600', ring: 'ring-amber-500/30', bg: 'bg-amber-500/10', text: 'text-amber-400', pulse: 'bg-amber-500', connected: true, group: 'clawd' },
