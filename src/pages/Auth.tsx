          ...
          <div className="flex items-center justify-center gap-4">
            ...
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.294 19.497h2.039L6.482 2.29H4.294L17.607 20.65z"/>
              </svg>
            </a>
            <a
              href="https://www.youtube.com/@WarrenGuru"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-foreground/70 hover:text-foreground transition-colors"
              aria-label="YouTube"
