      ...
      <div className="fixed inset-0 z-10 flex flex-col">
        ...
        <footer className="px-4 sm:px-6 md:px-12 py-3 sm:py-4 flex items-center justify-between relative z-30">
          ...
          <div className="flex items-center gap-3">
            <a href="https://discord.gg/warrenguru" target="_blank" rel="noopener noreferrer" className="text-muted-foreground/30 hover:text-muted-foreground/60 transition-colors">
